const apiUrl = 'https://easycontactsagenda.azurewebsites.net/api';
const editUrl = 'https://easycontactsagenda.azurewebsites.net/api';
const postUrl = 'https://easycontactsagenda.azurewebsites.net/api/new';
